...
Map<String, dynamic> devConstants = {'env_path': 'assets/env/.dev'};

Map<String, dynamic> stageConstants = {'env_path': 'assets/env/.stage'};

Map<String, dynamic> prodConstants = {'env_path': 'assets/env/.prod'};
